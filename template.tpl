...

{
  ...
  "description": "The JSON Tag Template was created to provide a vendor agnostic way to send JSON Payloads from the client-side Google Tag Manager to the server-side Google Tag Manager.",
  "containerContexts": [
    "WEB"
  ],
  "securityGroups": []
